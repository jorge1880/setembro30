...
<div class="container">
    ...
    <div class="fixed-action-btn">
        <a href="{{route('admin.post.create')}}" class="btn-floating btn-large bg-gradient-green modal-trigger waves-effect waves-light tooltipped" data-position="left" data-tooltip="Adicionar novo post"> 
        ...
        <div class="col s12 m6 l4">
            <div class="card hoverable" style="border-radius: 8px; overflow: hidden; height: auto; min-height: 450px;">
                ...
                <div class="card-content blue darken-1 white-text center-align" style="padding: 15px;">
                    <span class="card-title" style="font-size: 1.2rem; font-weight: 500; line-height: 1.3; display: block; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;" title="{{$post->titulo}}">
                        {{$post->titulo}}
                    </span>
                </div>
                    ...
                    <div>
                        ...
                        <div class="author" style="margin-bottom: 15px; padding: 8px 0; border-top: 1px solid #e0e0e0;">
                            <div class="chip blue lighten-5">
                                ...
                                <span class="blue-text text-darken-2" style="font-size: 0.9rem;">{{$post->user->nome}}</span>
                            </div>
                        </div>

                      
                <div class="card-action center-align" style="padding: 0;">
                    <a href="{{ route('single.post', $post->id) }}" class="btn waves-effect waves-light blue darken-1" style="margin-right: 5px; border-radius: 4px; font-size: 0.9rem;">
                        <i class="material-icons left small">visibility</i>
                        Ver mais
                    </a>
                    @can('update', $post)
                    <a href="{{ route('admin.post.edit', $post->id) }}" class="btn-small waves-effect waves-light orange tooltipped" style="border-radius: 4px; margin-right: 3px;" data-position="top" data-tooltip="Editar">
                        <i class="material-icons">edit</i>
                    </a>
                    @endcan
                    @can('delete', $post)
                    <a href="#delete-{{ $post->id }}" class="btn btn-small modal-trigger waves-effect waves-light red tooltipped" style="border-radius: 4px;" data-position="top" data-tooltip="Excluir">
    ...
    @empty
        ...
        <div class="col s12">
            <div class="card-panel center-align grey lighten-4" style="padding: 60px 20px; border-radius: 8px;">
                ...
                <h5 class="grey-text text-darken-1">Nenhum post encontrado</h5>
                <p class="grey-text">Clique no botão + para adicionar seu primeiro post</p>
