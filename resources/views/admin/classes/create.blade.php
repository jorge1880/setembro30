...
@section('conteudo')
  ...
  <div class="container col s12 m6" style="margin-top: 50px; max-width:500px; ">
    <div class="card-panel">
        <form action="{{route('admin.classe.store')}}" method="POST" class="col s12 m6"> 
     
          @csrf
          <a href="{{ route('admin.classes') }}" class="btn-floating waves-effect waves-light blue left" style="margin-right: 10px;">
              <i class="material-icons">arrow_back</i>
          </a>
         <a href="#" class="btn-floating"><i class="material-icons ">school</i></a> <span style="font-size: 20pt">Nova Classe</span>
          <br>
     
  
          <div class="input-field col s12" style="margin-top: 30px">
            <input name="designacao" id="designacao" type="text" class="validate" >
