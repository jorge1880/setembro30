...
@section('conteudo')
  ...
  <div class="container col s12 m6" style="margin-top: 50px; max-width:500px; ">
    <div class="card-panel">
     <form action="{{route('admin.ano.store')}}" method="POST" class="col s12 m6"> 

       @csrf
       <a href="{{ route('admin.anos') }}" class="btn-floating waves-effect waves-light blue left" style="margin-right: 10px;">
           <i class="material-icons">arrow_back</i>
       </a>
      <a href="#" class="btn-floating"><i class="material-icons ">calendar_month</i></a> <span style="font-size: 20pt">Novo Ano Lectivo</span>
       <br>
      
      <div class="row">

       <div class="input-field col s12">
        <input name="ano" id="ano" type="text" class="validate">
