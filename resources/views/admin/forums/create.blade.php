  ...
  <div class="container col s12 m4" style="margin-top: 50px; max-width:900px">
    <div class="card-panel">
        ...
        <div class="col s12 center" style="margin-bottom: 30px;">
            <a href="{{ route('admin.forums') }}" class="btn-floating waves-effect waves-light blue left" style="margin-right: 10px; position: absolute; top: 0; left: 20px;">
            ...
            <h6 class="grey-text">Crie Forums para tirar duvidas das aulas</h6>
        </div>
    </div>
         ...
         <div class="input-field col s12">
                <input type="text" name="tema_forum" value="" id="tema_forum">
                  <label for="tema_forum">TÍTULO</label>
                @error('tema_forum')
               ...
               <div class="input-field col s12">
                ...
                <label for="id_turma">Este Forum é para Turma</label>
                @error('id_turma')
                 <span class="red-text">{{$message}}</span>
                 @enderror
              </div>
        ...
        <div class="" style="text-align: right">
          <a href="{{route('admin.forums')}}" class="waves-effect waves-green btn red">Cancelar</a>
