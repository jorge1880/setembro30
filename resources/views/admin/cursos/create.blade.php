 ...
 @section('conteudo')
   ...
   <div class="container col s12 m6" style="margin-top: 50px; max-width:500px; ">
     <div class="card-panel">
      <form action="{{route('admin.curso.store')}}" method="POST" class="col s12 m6"> 

        @csrf
        <a href="{{ route('admin.cursos') }}" class="btn-floating waves-effect waves-light blue left" style="margin-right: 10px;">
            <i class="material-icons">arrow_back</i>
        </a>
       <a href="#" class="btn-floating"><i class="material-icons ">library_books</i></a> <span style="font-size: 20pt">Novo Curso</span>
        <br>
       
       <div class="row">

        <div class="input-field col s12">
          <input name="nome" id="first_name" type="text" value="{{old('nome')}}" class="validate" >
