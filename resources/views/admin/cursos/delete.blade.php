<!-- Modal Structure OF DELETING A COURSE-->
     <div id="delete-{{$curso->id}}" class="modal" style="max-width: 500px">
        <div class="modal-content">
          <h4><i class="material-icons">delete</i> Tem certeza </h4>
            <div class="row">
    
              <p>Que quer excluir o Curso <b style="color: red"> {{$curso->nome}} ?</b></p>
