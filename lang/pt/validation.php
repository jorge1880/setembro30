...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'email' => [
            'unique' => 'Este endereço de e-mail já está sendo utilizado por outro usuário.',
        ],
        'num_agente' => [
            'unique' => 'Este número de agente já está sendo utilizado por outro professor.',
        ],
        'n_bilhete' => [
            'unique' => 'Este número de bilhete já está sendo utilizado por outro usuário.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'num_agente' => 'número do agente',
        'n_bilhete' => 'número do bilhete',
